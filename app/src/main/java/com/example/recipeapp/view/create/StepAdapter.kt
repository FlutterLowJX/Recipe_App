...
class StepAdapter(dataSet: MutableList<String> = mutableListOf(), private val setText: (String, String, Int?) -> Unit) : DragDropSwipeAdapter<String, StepAdapter.ViewHolder>(dataSet) {
